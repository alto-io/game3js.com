...
import featsArr from 'shared/data/open-source'
import Banner from 'shared/components/banner'
import styles from './index.module.css'

const OpenSource = ({ intl: { messages } }) => {
  const translationFeats = messages.opensource.list
    ...
    <div className={ styles.container } >
      ...
      */}
      <div className={ styles.content } >
        <h1>{ messages.opensource.sectionTitle }</h1>
        <ReactMarkdown className={ styles.sectionDescription } source={ messages.opensource.sectionDesc } />
