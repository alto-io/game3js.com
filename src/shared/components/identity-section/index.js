...
import identityAppsData from 'shared/data/identity'
...
class WhatYouCanBuild extends PureComponent {
  ...
  render () {
    ...
    const activeLink = identityAppsData.apps[activePillIndex].link
          ...
          <div className={ styles.content }>
            ...
            */
            ...
            <p>
              ...
              <Link href={ identityAppsData.repoLink } >
  ...
  renderNavPills = () => identityAppsData.apps.map((app, index) => (
    <NavPill
      key={ `app-${index}` }
      index={ index }
      title={ app.title }
